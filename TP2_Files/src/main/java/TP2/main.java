...
public class main {
	...
	static File f = new File("Inventario.dat");
    ...
    static void agregarProducto() {        
        ...
        while (true) {
        	...
        	if(identificarTipo(precioCompra) != "no numero" && identificarTipo(precioVenta) != "no numero" && identificarTipo(stock) == "entero") {
        ...
        for (int i = 0; i < productos.size(); i++) {
            ...
            if (datos[0].equalsIgnoreCase(nombre)) {
                ...
                while (true){
                	...
                	if(identificarTipo(nuevoCompra) != "no numero" && identificarTipo(nuevoVenta) != "no numero" && identificarTipo(nuevoStock) == "entero") {
