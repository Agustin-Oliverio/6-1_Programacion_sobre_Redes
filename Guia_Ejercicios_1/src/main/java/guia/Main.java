        ...
        while (opcion != 0) {
            ...
            try {
                ...
                switch (opcion) {
                    ...
                    case 2 -> Ejercicios.valorAnguloRestante(ps);
                    case 3 -> Ejercicios.calcularPerimetroCuadrado(ps);
                    case 4 -> Ejercicios.calcularGradosCent(ps);
                    case 5 -> Ejercicios.transformarSegundos(ps);
                    case 6 -> Ejercicios.calcularPlan(ps);
                    case 7 -> Ejercicios.calcularMesNacimiento(ps);
