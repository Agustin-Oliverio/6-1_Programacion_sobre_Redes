...
public class Ejercicios {
	...
	public static void main(String[] args) {
		...
		try {
			salarioBruto(ps);
			valorAnguloRestante(ps);
			calcularPerimetroCuadrado(ps);
			calcularGradosCent(ps);
			transformarSegundos(ps);
			calcularPlan(ps);
			calcularMesNacimiento(ps);
	...
	// valorAnguloRestante
	public static void valorAnguloRestante(PrintStream ps)
	{
	...
	// calcularGradosCent
	public static void calcularGradosCent(PrintStream ps)
	{
		ps.print("Ingrese la temperatura en grados fahrenheit: ");
		int tempFahr = Integer.parseInt(leerLinea());
	...
	// transformarSegundos
	public static void transformarSegundos(PrintStream ps)
	{
	...
	public static void calcularMesNacimiento(PrintStream ps)
	{
	...
	// indicarSiEsPar
	public static void indicarSiEsPar(PrintStream ps, PrintStream psErr, BufferedReader br)
			throws IOException, NumberFormatException {
	...
	public static void calcularSiEsDivisible(PrintStream ps, PrintStream psErr, BufferedReader br)
			throws IOException, NumberFormatException {
		ps.print("Ingrese el primer numero: ");
		double num1 = Double.parseDouble(br.readLine());
		ps.print("Ingrese el segundo numero: ");
	...
	public static void calcularSignoZodiacal(PrintStream ps, PrintStream psErr, BufferedReader br)
			throws IOException, NumberFormatException {
