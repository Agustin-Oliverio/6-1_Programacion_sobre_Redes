...
public class Ejercicios {
    ...
    public static void main(String[] args) {
        ...
        try {
            salarioBruto(ps, psErr, br);
            valorAnguloRestante(ps, psErr, br);
            calcularPerimetroCuadrado(ps, psErr, br);
            calcularGradosCent(ps, psErr, br);
            transformarSegundos(ps, psErr, br);
            calcularPlan(ps, psErr, br);
            calcularMesNacimiento(ps, psErr, br);
            ordenarAlfabeticamente(ps, psErr, br);
            indicarMenor(ps, psErr, br);
            indicarSiEsPar(ps, psErr, br);
            calcularSiEsDivisible(ps, psErr, br);
            calcularSignoZodiacal(ps, psErr, br);
    ...
    // salarioBruto
    public static void salarioBruto(PrintStream ps, PrintStream psErr, BufferedReader br) throws IOException, NumberFormatException {
    ...
    // valorAnguloRestante
    public static void valorAnguloRestante(PrintStream ps, PrintStream psErr, BufferedReader br) throws IOException, NumberFormatException {
    ...
    public static void calcularPerimetroCuadrado(PrintStream ps, PrintStream psErr, BufferedReader br) throws IOException, NumberFormatException {
    ...
    // calcularGradosCent
    public static void calcularGradosCent(PrintStream ps, PrintStream psErr, BufferedReader br) throws IOException, NumberFormatException {
    ...
    // transformarSegundos
    public static void transformarSegundos(PrintStream ps, PrintStream psErr, BufferedReader br) throws IOException, NumberFormatException {
    ...
    // calcularPlan
    public static void calcularPlan(PrintStream ps, PrintStream psErr, BufferedReader br) throws IOException, NumberFormatException {
    ...
    // calcularMesNacimiento
    public static void calcularMesNacimiento(PrintStream ps, PrintStream psErr, BufferedReader br) throws IOException {
    ...
    // indicarMenor
    public static void indicarMenor(PrintStream ps, PrintStream psErr, BufferedReader br) throws IOException, NumberFormatException {
    ...
    // indicarSiEsPar
    public static void indicarSiEsPar(PrintStream ps, PrintStream psErr, BufferedReader br) throws IOException, NumberFormatException {
    ...
    // calcularSiEsDivisible
    public static void calcularSiEsDivisible(PrintStream ps, PrintStream psErr, BufferedReader br) throws IOException, NumberFormatException {
        ps.print("Ingrese el primer numero: ");
        double num1 = Double.parseDouble(br.readLine());
        ps.print("Ingrese el segundo numero: ");
        double num2 = Double.parseDouble(br.readLine());
    ...
    public static void calcularSignoZodiacal(PrintStream ps, PrintStream psErr, BufferedReader br) throws IOException, NumberFormatException {
    ...
    // calcularApellidoMasLargo
    public static void calcularApellidoMasLargo(PrintStream ps, PrintStream psErr, BufferedReader br) throws IOException {
    ...
    // indicarMultiplos
    public static void indicarMultiplos(PrintStream ps, PrintStream psErr, BufferedReader br) throws IOException, NumberFormatException {
    ...
    // indicarSiEsPrimo
    public static void indicarSiEsPrimo(PrintStream ps, PrintStream psErr, BufferedReader br) throws IOException, NumberFormatException {
